...
~~~
![alt text](https://github.com/Nkulbaka1/LAB_2/assets/129120650/681d0d84-8566-4a1f-8d65-4debc817edd5)
...
WHERE "АВТОМОБИЛЬ"."МАРКА" = 'Зил-130'
	AND ("ГАРАЖ"."РАСПОЛОЖЕНИЕ" = 'АТП1'
	OR   "ГАРАЖ"."РАСПОЛОЖЕНИЕ" = 'АТП2');
~~~
![alt text](https://github.com/Nkulbaka1/LAB_2/assets/129120650/ddf620ee-3fc8-4548-b1dd-66fcddc46ed0)
...
13. Используя операцию UNION получить места расположения машин и АТП-владельцы гаражей.
~~~SQL
SELECT "АТП-ВЛАДЕЛЕЦ"
FROM "АВТОМОБИЛЬ"
UNION
